...
public class UserEditController {
	...
	public String view(Model model, UserEditForm form) throws Exception {
		...
		/*
		 * if (userInfoOpt.isEmpty()) { model.addAttribute(ModelKey.MESSAGE,
		 * AppUtil.getMessage(messageSource,
		 * MessageConst.USEREDIT_NON_EXISTED_LOGIN_ID)); return
		 * ViewNameConst.USER_EDIT_ERROR; }
		 */
